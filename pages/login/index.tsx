      ...
      <Layout>
        <section className="container py-10 m-auto">
          <div className="lg:flex lg:items-center">
                ...
                <div className="mt-12">
                  <form onSubmit={handleSubmit} autoComplete="off">
                    <div>
                      ...
                      <input
                        className="w-full px-2 py-2 text-lg border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                        type="email"
            ...
            <div className="items-center justify-center flex-1 hidden h-[80vh] bg-indigo-100 lg:flex">
